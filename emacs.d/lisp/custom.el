(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (counsel button-lock ibuffer-sidebar smart-mode-line ag ivy neotree sr-speedbar fixmee flycheck flycheck-rust rust-mode exec-path-from-shell flycheck-haskell haskell-mode sublimity electric-pair magit yasnippet-snippets yasnippet latex-preview-pane auctex))))
(custom-set-faces
